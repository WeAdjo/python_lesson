...
words_list = [temp_str.split()]
print(words_list)

#приводим к нижнему регистру
low_reg = temp_str.lower()
...
print('Словарь:', words_dict)

#определяем 5 наиболее встречающихся слов
list_words_dict = list(words_dict.items())
list_words_dict.sort(key=lambda i: i[1])
list_words_dict.reverse()
print('Наиболее пять встречающихся слов -', list_words_dict[0:5])
